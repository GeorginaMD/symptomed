...
export default function DisclaimerModal({ type, onClose }) {
  const content = {
    ...
    contact: `Contact - 
        This application was created and is maintained by a web developer focused on health-related educational tools. For questions, feedback, or data-related requests, you can contact me: https://github.com/GeorginaMD .`
  };
